...
\begin{enumerate}[label=(\alph*)]
	...
	\item perceive an anomalous lag in plant response to commands.
\end{enumerate}	
...
Both the nominal and recovery adaptive controllers utilize a number of free design parameters, including LQR weight matrices and adaptation rates. Their numerical values in these simulations are available online\footnote{\texttt{http://aaclab.mit.edu/resources/cphs-2018/}}.
